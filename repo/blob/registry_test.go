...
func TestRegistry(t *testing.T) {
	blob.AddSupportedStorage("mystorage", func(c context.Context, mc *myConfig, isCreate bool) (blob.Storage, error) {
...
func TestConnectionInfo(t *testing.T) {
	blob.AddSupportedStorage("mystorage2", func(c context.Context, mc *myConfig, isCreate bool) (blob.Storage, error) {
